...
export const TEAM_SIZE_OPTIONS: BucketOption[] = [
  { value: "solo", points: 1, label: { "en-US": "Just me", "es-ES": "Solo yo" }, keywords: { "en-US": ["just me", "solo", "one person", "myself"], "es-ES": ["solo yo", "una persona"] } },
  { value: "small", points: 1, label: { "en-US": "2–10 people", "es-ES": "2–10 personas" }, keywords: { "en-US": ["2", "10", "small team", "few people"], "es-ES": ["2", "10", "equipo pequeño"] } },
  { value: "medium", points: 2, label: { "en-US": "11–50 people", "es-ES": "11–50 personas" }, keywords: { "en-US": ["11", "50", "medium"], "es-ES": ["11", "50", "mediano"] } },
  { value: "large", points: 2, label: { "en-US": "50+ people", "es-ES": "50+ personas" }, keywords: { "en-US": ["50+", "large", "enterprise", "hundreds"], "es-ES": ["50+", "grande", "empresa grande", "cientos"] } },
];

export const BUDGET_OPTIONS: BucketOption[] = [
  { value: "under_500", points: 0, label: { "en-US": "Under $500/mo", "es-ES": "Menos de $500/mes" }, keywords: { "en-US": ["under 500", "less than 500", "no budget", "not much"], "es-ES": ["menos de 500", "sin presupuesto"] } },
  { value: "500_2k", points: 1, label: { "en-US": "$500–$2,000/mo", "es-ES": "$500–$2,000/mes" }, keywords: { "en-US": ["500", "1000", "1500", "2000", "2k"], "es-ES": ["500", "1000", "1500", "2000"] } },
  { value: "2k_10k", points: 2, label: { "en-US": "$2,000–$10,000/mo", "es-ES": "$2,000–$10,000/mes" }, keywords: { "en-US": ["2000", "5000", "10000", "10k"], "es-ES": ["2000", "5000", "10000"] } },
  { value: "10k_plus", points: 3, label: { "en-US": "$10,000+/mo", "es-ES": "$10,000+/mes" }, keywords: { "en-US": ["10000+", "10k+", "big budget", "flexible budget"], "es-ES": ["10000+", "presupuesto grande", "presupuesto flexible"] } },
];

export const TIMELINE_OPTIONS: BucketOption[] = [
  { value: "immediate", points: 3, label: { "en-US": "Ready now / this month", "es-ES": "Listo ahora / este mes" }, keywords: { "en-US": ["now", "this month", "asap", "immediately", "ready now"], "es-ES": ["ahora", "este mes", "inmediatamente", "lo antes posible"] } },
  { value: "quarter", points: 2, label: { "en-US": "This quarter", "es-ES": "Este trimestre" }, keywords: { "en-US": ["this quarter", "few months", "next few months"], "es-ES": ["este trimestre", "próximos meses"] } },
  { value: "half_year", points: 1, label: { "en-US": "Next 6 months", "es-ES": "Próximos 6 meses" }, keywords: { "en-US": ["6 months", "half year", "later this year"], "es-ES": ["6 meses", "medio año", "más adelante este año"] } },
  { value: "exploring", points: 0, label: { "en-US": "Just exploring", "es-ES": "Solo explorando" }, keywords: { "en-US": ["just looking", "exploring", "no rush", "not sure yet"], "es-ES": ["solo mirando", "explorando", "sin prisa", "no estoy seguro"] } },
];
